...
This release adds compact Evidence Packs for graph-first agent workflows and
fixes npm publication coverage for the Semantic Index package.
...
- The npm publish script now includes `@0xsarwagya/ontoly-index`, repairing the
  missing dependency for published CLI installs.
