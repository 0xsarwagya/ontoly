...
description: "Runtime, package, Software Graph, Agent Skill, MCP, CLI, and release compatibility for Ontoly v1.2.0."
---
...
in v1.2.0 and is not supported.
