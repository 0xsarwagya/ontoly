...
metadata:
  ...
  ontoly.capabilities: "ExplainArchitecture, TraceRequestLifecycle, InspectModule, GraphStatistics"
...
Use these capabilities first: `ExplainArchitecture`, `TraceRequestLifecycle`, `InspectModule`, `GraphStatistics`.
