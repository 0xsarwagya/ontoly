...
order: 1
canonical: "https://ontoly.xyz/docs"
...
Ontoly turns a JavaScript or TypeScript repository into a deterministic Software Graph.
...
- [Known Limitations](/docs/known-limitations) - what v1.0.0 intentionally does not cover.
...
Stable. The JavaScript/TypeScript frontend, Software Graph, Query Engine,
