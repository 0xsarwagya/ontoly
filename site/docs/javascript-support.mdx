...
description: "Ontoly analyzes JavaScript and TypeScript with one deterministic frontend built on the TypeScript Compiler API."
canonical: "https://oss.sarwagya.wtf/ontoly/docs/javascript-support"
source: "docs/javascript-support.md"
keywords: ["Ontoly", "Software Graph", "TypeScript", "static analysis", "MCP", "AI coding agents", "developer tools", "JavaScript", "Support"]
---
...
by the [Framework Matrix](./framework-matrix).
