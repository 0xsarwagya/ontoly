---
title: "JavaScript and TypeScript Semantic Model"
description: "The TypeScript Semantic Model is Ontoly's JavaScript and TypeScript language layer."
canonical: "https://ontoly.xyz/docs/typescript-semantic-model"
source: "docs/typescript-semantic-model.md"
keywords: ["Ontoly", "Software Graph", "TypeScript", "static analysis", "MCP", "AI coding agents", "developer tools", "JavaScript", "Semantic", "Model"]
---
