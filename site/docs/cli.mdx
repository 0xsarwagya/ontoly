...
canonical: "https://ontoly.xyz/docs/cli"
source: "docs/cli.md"
...
- `ontoly leaderboard`
- `ontoly diff <base.graph> <head.graph>` — deterministic graph diff per [RFC 0005](https://github.com/0xsarwagya/ontoly/blob/main/rfcs/0005-graph-diffing.md). See [Graph Diffing](./graph-diffing).
...
See [Repository Intelligence](./repository-intelligence) for the derived
