...
description: "The Validation Lab is Ontoly's permanent release-gate infrastructure. It measures correctness, determinism, semantic understanding, performance, scala"
---
