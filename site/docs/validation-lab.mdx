...
canonical: "https://ontoly.xyz/docs/validation-lab"
...
The diff is deterministic and defined by [RFC 0005](https://github.com/0xsarwagya/ontoly/blob/main/rfcs/0005-graph-diffing.md).
It reports added, removed, and modified nodes and added or removed
edges. See [Graph Diffing](./graph-diffing) for the full contract.
