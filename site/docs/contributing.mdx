...
canonical: "https://ontoly.xyz/docs/contributing"
...
[Contributor License Agreement](https://github.com/0xsarwagya/ontoly/blob/main/CONTRIBUTOR_LICENSE_AGREEMENT.md). The CLA
