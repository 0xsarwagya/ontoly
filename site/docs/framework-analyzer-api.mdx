...
description: "Framework analyzers turn the JavaScript/TypeScript Semantic Model into framework semantic facts."
canonical: "https://ontoly.xyz/docs/framework-analyzer-api"
