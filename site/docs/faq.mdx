---
title: "FAQ"
description: "Developer tools keep rebuilding the same understanding of a codebase. Ontoly builds one deterministic Software Graph so tools can query shared structu"
---
