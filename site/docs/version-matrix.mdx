...
| Component | Version |
| --------- | ------- |
| Ontoly core packages | 0.1.0-alpha.1 to 0.1.0-alpha.4 |
| Query Engine | 0.1.0-alpha.2 |
| TypeScript analyzer | 0.1.0-alpha.2 |
| TypeScript parser frontend | 0.1.0-alpha.2 |
| Semantic Index | exported by `@0xsarwagya/ontoly-core` 0.1.0-alpha.2 |
| Semantic Capability Engine | 0.1.0-alpha.4 |
| Enhancer API | 0.1.0-alpha.4 |
| MCP runtime | 0.1.0-alpha.6 |
| Ontoly CLI | 0.1.0-alpha.12 |
| HTML graph plugin | 0.1.0-alpha.3 |
| Software Graph Spec | 1.0 draft |
| Agent Skills | 0.1.0-alpha.4 to 0.1.0-alpha.6 |
| Node.js engine | 22+ |
| pnpm engine | 11+ |
| TypeScript | 5.9 |
