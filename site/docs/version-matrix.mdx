...
| Component | Version |
| --------- | ------- |
| Ontoly core packages | 1.0.0-rc.22 |
| Query Engine | 1.0.0-rc.22 |
| TypeScript analyzer | 1.0.0-rc.22 |
| JavaScript/TypeScript parser frontend | 1.0.0-rc.22 |
| Semantic Index | exported by `@0xsarwagya/ontoly-core` 1.0.0-rc.22 |
| Semantic Capability Engine | 1.0.0-rc.22 |
| Enhancer API | 1.0.0-rc.22 |
| Semantics Enhancer | 1.0.0-rc.22 |
| Intelligence API | 1.0.0-rc.22 |
| MCP runtime | 1.0.0-rc.22 |
| Ontoly CLI | 1.0.0-rc.22 |
| HTML graph plugin | 1.0.0-rc.22 |
| Software Graph Spec | 1.0 draft |
| Agent Skills | 1.0.0-rc.22 |
| Node.js engine | 20+ |
| pnpm engine | 10+ |
| TypeScript | 5.9 |
