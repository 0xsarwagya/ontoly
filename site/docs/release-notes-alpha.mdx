...
description: "This release adds compact Evidence Packs for graph-first agent workflows and fixes npm publication coverage for the Semantic Index package."
