...
description: "This stabilization release fixes retrieval quality, bounded evidence, and capability latency issues discovered during real-world Ovok Core evaluation."
