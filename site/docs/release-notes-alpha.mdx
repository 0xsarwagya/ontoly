...
description: "This release fixes external npm installation by removing the hidden standalone Semantic Index package dependency from the public CLI graph."
