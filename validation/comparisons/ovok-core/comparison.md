...
| --- | ---: | ---: | ---: | --- | --- |
| Functions | 1262 | 0 | 1262 | graphify_missing | not measured |
...
| Modules | 1965 | 0 | 1965 | graphify_missing | not measured |
| Services | 237 | 0 | 237 | graphify_missing | not measured |
| Providers | 419 | 0 | 419 | graphify_missing | not measured |
| Repositories | 0 | 0 | 0 | not_observed | not measured |
| Packages | 121 | 0 | 121 | graphify_missing | not measured |
...
| Item | Ontoly | Graphify | Delta | Status | Incorrect |
| --- | ---: | ---: | ---: | --- | --- |
| CALLS | 5640 | 0 | 5640 | graphify_missing | not measured |
| IMPORTS | 10056 | 0 | 10056 | graphify_missing | not measured |
| EXPORTS | 2697 | 0 | 2697 | graphify_missing | not measured |
| CONTAINS | 18443 | 0 | 18443 | graphify_missing | not measured |
| HANDLES | 423 | 0 | 423 | graphify_missing | not measured |
| MOUNTS | 420 | 0 | 420 | graphify_missing | not measured |
| INJECTS | 1916 | 0 | 1916 | graphify_missing | not measured |
| READS | 157 | 0 | 157 | graphify_missing | not measured |
| WRITES | 2 | 0 | 2 | graphify_missing | not measured |
| USES | 3019 | 0 | 3019 | graphify_missing | not measured |
...
| RETURNS | 1348 | 0 | 1348 | graphify_missing | not measured |
...
| --- | ---: | ---: | --- |
| Ontoly | 10508.75ms | 3.1 GB | 0io8q3z |
| Graphify | 190.97ms | 40.2 MB | e36634175223f5b2f5abd7582c60155c47fc3947ec8ae82165c8dcbe7d7ae4b2 |

## Diagnostics

- Ontoly compiler diagnostics: 18
...
- Functions: Ontoly produced 1262 Functions; Graphify produced 0 in the normalized model. (inferred from normalized counts)
...
- Modules: Ontoly produced 1965 Modules; Graphify produced 0 in the normalized model. (inferred from normalized counts)
- Services: Ontoly produced 237 Services; Graphify produced 0 in the normalized model. (inferred from normalized counts)
- Providers: Ontoly produced 419 Providers; Graphify produced 0 in the normalized model. (inferred from normalized counts)
- Packages: Ontoly produced 121 Packages; Graphify produced 0 in the normalized model. (inferred from normalized counts)
...
- INJECTS: Ontoly produced 1916 INJECTS relationships; Graphify produced 0. (inferred from normalized counts)
