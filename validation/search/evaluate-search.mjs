...
const indexModule = await import(pathToFileURL(resolve("packages/core/dist/index.js")).href).catch((error) => {
  throw new Error("Build @0xsarwagya/ontoly-core before running search evaluation.", { cause: error });
});
